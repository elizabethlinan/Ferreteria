...
<a href="#" onclick="javascript:document.body.style.backgroundColor='#EDB036'; document.body.style.backgroundImage='none';">Naranja</a>
<a href="#" onclick="javascript:document.body.style.backgroundColor='#F5B7B1 '; document.body.style.backgroundImage='none';">Rojo claro</a>
 <a href="#" onclick="javascript:document.body.style.backgroundColor='#5DED36'; document.body.style.backgroundImage='none';">verde</a>
<a href="#" onclick="javascript:document.body.style.backgroundColor='#B3B6B7'; document.body.style.backgroundImage='none';">Gris</a>
		 <div class="col-md-23" >  
										...
										<tbody>
												...
												<c:forEach items="${productos}" var="x">
													<tr>
														...
														<td>${x.estado}</td>
														<td>
															<button type='button' data-toggle='modal' onclick="editar('${x.idProducto}','${x.nombre}','${x.marca}','${x.stock}','${x.estado}');" class='btn btn-success' style='background-color:hsla(233, 100%, 100%, 0);'>
...
function editar(id,nombre,marca,stock,estado){	
